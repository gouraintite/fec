          ...
          <div className="h-auto py-12 rounded-xl shadow-xl bg-white/95">
            ...
            <div className="flex justify-center px-16 w-full bg-white py-24">
              <div className="space-y-4 w-full">
                ...
                >
                  <p className="text-lg font-semibold w-5/6">Notification de sécurité</p>
                </Button>
                <Button
                  onClick={()=>{navigate('/eight')}}
                  variant="outlined"
                  ...
                  className="flex text-black duration-300 ease-in-out hover:bg-orange-400 hover:text-white w-full justify-around items-center gap-3"
                >
                  <p className="text-lg font-semibold w-5/6">Demander infos compte</p>
                </Button>
                <Button
                  onClick={()=>{navigate('/eight')}}
                  variant="outlined"
                  ...
                  className="flex text-black duration-300 ease-in-out hover:bg-orange-400 hover:text-white w-full justify-around items-center gap-3"
                >
                  <p className="text-lg font-semibold w-5/6">Supprimer le compte</p>
                </Button>
                <Button
                  onClick={()=>{navigate('/eight')}}
                  variant="outlined"
                  ...
                  className="flex text-black duration-300 ease-in-out hover:bg-orange-400 hover:text-white w-full justify-around items-center gap-3"
                >
                  <p className="text-lg font-semibold w-5/6">changer le compte</p>
                </Button>
              </div>
            </div>
          </div>
